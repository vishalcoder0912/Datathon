/**
 * @fileoverview React Doctor linting and quality audit configuration.
 * Defines custom diagnostic rules and thresholds for React component performance and accessibility checks.
 * 
 * @module config/doctor
 */
